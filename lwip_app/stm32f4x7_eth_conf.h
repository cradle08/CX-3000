...
#ifdef USE_Delay
  #include "Scope_It.h"          /* Header file where the Delay function prototype is exported */
  #define _eth_delay_    IT_SYS_DlyMs   /* User can provide more timing precise _eth_delay_ function 
...
/* Redefinition of the Ethernet driver buffers size and count */
 ...
 #define ETH_TXBUFNB        8                    /* 4 Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
#define PHY_SR		             ((uint16_t)31)      // LAN8720 的PHY状态寄存器地址
