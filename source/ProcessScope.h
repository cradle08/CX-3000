...
#define    CMD_QUERY_ELECTRODE   		0x20000107//0x00000001
...
#define    CMD_QUERY_PRESS_ADD   		0x00000205
#define    CMD_QUERY_CUR_V_XK   		0x20000206
...
#define    CMD_STATUS_TURN_MOTOR_RESET 	0x01000905
//#define    CMD_STATUS_MIXING_MOTOR   	0x02000906
...
typedef enum
{
    ...
    MOTO_WORK_STAT_OK   = 1,       /* 执行成功 */
    MOTO_WORK_STAT_FAIL =2     /* 执行失败 */
}
MOTO_WORK_STAT_E;
