...
#define PLL_M      8         // changed by LHT, 336
#else /* STM32F411xE */
#if defined (USE_HSE_BYPASS)
#define PLL_M      8    
#else /* STM32F411xE */   
...
#if defined (STM32F40_41xxx)   // for 50MHz, PLL_N = 48
#define PLL_N      336  //    224   //   240       // changed by LHT, 336
  ...
  */
	...
	static void SetSysClock(void)
	{
	 ...
	 //------------------------------
		...
		RCC->PLLCFGR = 16 | (336 << 6)|(((PLL_P >> 1) -1) << 16) | (RCC_PLLCFGR_PLLSRC_HSI) | (PLL_Q << 24);
		/* Enable the main PLL */
		RCC->CR |= RCC_CR_PLLON;
